...
pub use entry::{
    ...
    remote_probe_script, remote_ssh_command, shell_quote, RemoteProbeFailure, RemoteProbeOutcome,
    RemoteProbeState, RemoteTarget, RepoEntry, RepoEntryKind, DEFAULT_SSH_PORT,
    REMOTE_PROBE_SHELL_COMMAND,
};
