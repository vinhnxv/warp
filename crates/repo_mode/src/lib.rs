...
pub use entry::{
    ...
    parse_probe_output, parse_remote_key, remote_probe_args, remote_probe_script, shell_quote,
    RemoteProbeFailure, RemoteProbeOutcome, RemoteProbeState, RemoteTarget, RepoEntry,
    RepoEntryKind, DEFAULT_SSH_PORT, REMOTE_PROBE_SHELL_COMMAND,
};
