...
use crate::settings::{init_and_register_user_preferences, AISettings, PrivacySettings};
...
pub fn register_tui_session_view_test_singletons(app: &mut warpui::App) {
    ...
    app.update(SessionSettings::register);
    app.update(TerminalSettings::register);
